/*
  # Add Schema Management Functions

  1. New Functions
    - `get_schema_tables()` - Returns all tables in the public schema
    - `get_table_columns(table_name)` - Returns column details for a specific table
  
  2. Security
    - Functions are accessible to authenticated users
    - Read-only operations on system tables
